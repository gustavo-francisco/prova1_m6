...
class TurtleController(Node):
    ...
    def __init__(self, mission_control, mission_control2, control_period=0.02):
        """
        ...
        self.mission_control2 = mission_control2
    ...
    def update_setpoint(self):
        ...
        try:
            ...
            self.get_logger().info(f"Mbpappé chegou em {self.pose}, \
                ...
                self.setpoint = self.pose + self.mission_control2.pop()
